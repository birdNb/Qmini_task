...
UNITREE_MODEL_DIR = "/home/nio/wenyan/isaac/isaaclab_demo/unitree_model"  # Replace with the actual path to your unitree_model directory
UNITREE_ROS_DIR = "/home/nio/wenyan/isaac/isaaclab_demo/unitree_ros"  # Replace with the actual path to your unitree_ros package
QMINI_ROS_DIR = "/home/nio/wenyan/isaac/isaaclab_demo/Qmini"
...
UNITREE_QMINI_CFG = UnitreeArticulationCfg(
    spawn=UnitreeUrdfFileCfg(
        asset_path=f"{QMINI_ROS_DIR}/urdf/Qmini.urdf",
    ),
    # spawn=UnitreeUsdFileCfg(
    #     usd_path=f"{UNITREE_MODEL_DIR}/G1/23dof/usd/g1_23dof_rev_1_0/g1_23dof_rev_1_0.usd",
    # ),
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.3),
        joint_pos={
            ".*L_joint1": 0.0,     # hip_yaw
            ".*L_joint2": 0.0,     # hip_roll
            ".*L_joint3": 0.3,     # hip_pitch
            ".*L_joint4": -0.8,    # knee
            ".*L_joint5": 0.5,     # ankle
        },
        joint_vel={".*": 0.0},
